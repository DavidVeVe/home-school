			...
			<div className='left-container'>
				...
				<form onSubmit={handleSubmitChild}>
					<div className='create-class'>
						...
						/>
						<br />
						<select onChange={handleRegisterChild}>
							<option name='Primaria' value='Primaria'>
								Primaria
							</option>
							<option name='Secundaria' value='Secundaria'>
								Secundaria
							</option>
						</select>
						<button className='btn btn-success btn-lg m-3 custom'>
							Añadir
						</button>
					</div>
				</form>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalChild);
